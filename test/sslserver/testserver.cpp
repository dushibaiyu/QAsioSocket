...
TestServer::TestServer(QObject *parent) : QObject(parent)
{
    ...
    server.setCertificateChainFile("E:/code/mygit/QAsioSocket/test/sslserver/server.pem");
    server.setPrivateKeyFile("E:/code/mygit/QAsioSocket/test/sslserver/server.pem",QAsioSslServer::PEM);
